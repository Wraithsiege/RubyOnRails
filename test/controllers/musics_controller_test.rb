...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference("Music.count") do
      post musics_url, params: { music: { albumName: @music.albumName, genre: @music.genre, performer: @music.performer, price: @music.price } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { albumName: @music.albumName, genre: @music.genre, performer: @music.performer, price: @music.price } }
