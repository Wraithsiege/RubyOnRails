...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference("Toy.count") do
      post toys_url, params: { toy: { color: @toy.color, manufacturer: @toy.manufacturer, name: @toy.name, price: @toy.price, type: @toy.type } }
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { color: @toy.color, manufacturer: @toy.manufacturer, name: @toy.name, price: @toy.price, type: @toy.type } }
